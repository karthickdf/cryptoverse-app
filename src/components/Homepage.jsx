...
const Homepage = () => {
  ...
  const globalStats = data?.data?.stats || {}; // ✅ Safe default

  if (isFetching) return <Loader />;

  if (error) {
    return <p style={{ color: 'red' }}>Error loading data. Please try again later.</p>;
  }

  if (!globalStats?.total) return <p>No data available.</p>;
